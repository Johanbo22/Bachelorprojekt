...
# Mapping of cardinal direction strings to degrees (0=East, 90=North,
# T
# (East=0, North=90).
...
def plot_wind_data(filename):
    ...
    try:
        ...
        if save: 
            ...
            plt.savefig(f"{output_folder}/Danmark_vinddata2.{format}", dpi=300, format=format)
            print("Gemt")
        else:
            print("Ikke gemt")
        plt.show()
