...
\noindent
Johan Bo Kjær$^{1*}$ and Mikkel Fruergaard$^{1*}$\\

\noindent
$^{1}$ Department of Geosciences and Natural Resource Management (IGN), University of Copenhagen, Øster Voldgade 10, DK-1350 Copenhagen K, Denmark.\\

\noindent
*Corresponding Authors: mcg811@alumni.ku.dk, mif@ign.ku.dk\\

\noindent
\textbf{Keywords}: GIS, inundation, coastal, storm, climate change**, Denmark, raster \\
